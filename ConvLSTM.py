'''
This ConvLSTMCell implementation was taken from https://github.com/automan000/Convolution_LSTM_PyTorch/blob/master/convolution_lstm.py
...
if __name__ == '__main__':
    ...
    # gradient check
    convlstm = ConvLSTM(input_channels=512, hidden_channels=[32], kernel_size=3, step=5, effective_step=[4])
